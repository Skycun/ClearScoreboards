...
public class ClearPerPlayerScoreboard extends ClearScoreboard {
  ...
  public ClearPerPlayerScoreboard(
  ...
  public ClearPerPlayerScoreboard(
    ...
    setOptions(ClearScoreboardOptions.defaultOptions);
   ...
   * This will not change in between updates, but will change if the player is removed and re-added to the ClearScoreboard.
