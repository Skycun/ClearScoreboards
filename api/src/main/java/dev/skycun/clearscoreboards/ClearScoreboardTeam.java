...
public class ClearScoreboardTeam {
  ...
  public void refresh() {
    if (this.scoreboard instanceof ClearPerPlayerScoreboard) {
      ...
      refresh(((ClearGlobalScoreboard) this.scoreboard).toBukkitScoreboard());
    }
  }
  ...
  private void handleRemoval(String entry) {
    if (scoreboard instanceof ClearGlobalScoreboard) {
      Team team = toBukkitTeam(((ClearGlobalScoreboard) scoreboard).toBukkitScoreboard());
      if (team == null) return;
      team.removeEntry(entry);
      return;
    }

    ClearPerPlayerScoreboard perPlayerScoreboard = (ClearPerPlayerScoreboard) scoreboard;
  ...
  protected void destroy() {
    if (this.scoreboard instanceof ClearPerPlayerScoreboard) {
      ...
      Scoreboard scoreboard = ((ClearGlobalScoreboard) this.scoreboard).toBukkitScoreboard();
  ...
  public ClearScoreboard getScoreboard() {
    return scoreboard;
  }
